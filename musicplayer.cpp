...
int main() {
    ...
    // // Adding songs
    // player.addSong(Song("Song1", "Artist1", "Pop"));
    // player.addSong(Song("Song2", "Artist2", "Rock"));
    // player.addSong(Song("Song3", "Artist3", "Jazz"));
    ...
    while(true){
        int choice;
        cout<<"Enter\n 1. For Adding User\n 2. For Selecting User\n 3. For Adding Song Details\n 4.Play Song \n 5.Play a random song \n 6.Display Listining History \n 7.Play previous song\n 8.Play next song \n 9.Adjust Volume\n 10.Display Playlist\n 11. Exit\n";
        cin>>choice;
        switch(choice){
            case 1:
                cout << "Enter username: ";
            ...
            case 2:
                ...
                break;
            case 3:  cout << "Enter song details:\n";
                cout << "ID: ";
                cin >> id;
                cout << "Title: ";
                cin >> title;
